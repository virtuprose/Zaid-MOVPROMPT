export const en = {
  ...
  "auth.gatePriceNote": "No charge is made until the final price is confirmed. Cancel to keep editing.",
  ...
  "auth.finalPriceNotice": "You’ll confirm the final render price after authentication.",
