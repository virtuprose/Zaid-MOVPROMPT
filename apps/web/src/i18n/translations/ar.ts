...
export const ar: Record<TranslationKey, string> = {
  ...
  "auth.gatePriceNote": "لن يتم الخصم قبل تأكيد السعر النهائي. أغلق النافذة لمتابعة التعديل.",
  ...
  "auth.finalPriceNotice": "راح تأكد سعر التوليد النهائي بعد تسجيل الدخول.",
