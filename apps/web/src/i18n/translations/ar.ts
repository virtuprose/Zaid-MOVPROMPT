...
export const ar: Record<TranslationKey, string> = {
  ...
  "auth.gateDescription": "أنشئ حساباً لبدء التوليد. سيعود منتجك والقالب وإعدادات الحملة كما تركتها تماماً في هذا المتصفح.",
  ...
  "auth.verificationLaterNotice": "تأكيد البريد اختياري خلال النسخة التجريبية الخاصة. تقدر تأكده لاحقاً من إعدادات الحساب.",
