...
const forbidden = [
  ...
  { name: "private object key", pattern: /\b(?:private|users|assets)\/[A-Za-z0-9_./-]{8,}/i },
...
if (violations.length > 0) {
  console.error("Phase 2 evidence contains restricted material:\n" + violations.join("\n"));
  process.exit(1);
}

console.log(`Phase 2 evidence redaction passed for ${targets.length} file(s).`);
