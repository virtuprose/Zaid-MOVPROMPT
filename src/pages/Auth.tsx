                    ...
                    {forgotMode ? (
                      <form onSubmit={handleForgotPassword} className="space-y-3 mt-3">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Input className="bg-[#161618] border border-[#2A2A2E] text-foreground placeholder:text-[#71717A] rounded-lg px-4 py-[14px] h-auto focus-visible:border-[#F5A524]/50 focus-visible:ring-0 focus-visible:ring-offset-0" id="forgot-email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                        </div>
                      ...
                      <form onSubmit={handleEmailSignIn} className="space-y-3 mt-3">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Input className="bg-[#161618] border border-[#2A2A2E] text-foreground placeholder:text-[#71717A] rounded-lg px-4 py-[14px] h-auto focus-visible:border-[#F5A524]/50 focus-visible:ring-0 focus-visible:ring-offset-0" id="signin-password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required />
                        </div>
                        <Button type="submit" className="w-full h-11 hover:scale-[1.02] active:scale-[0.98]" disabled={loading}>
                          {loading ? <Loader2 className="w-4 h-4 animate-spin me-2" /> : <Mail className="w-4 h-4 me-2" />}
                          {t("auth.signIn")}
                  ...
                  <TabsContent value="signup">
                    <form onSubmit={handleEmailSignUp} className="space-y-3 mt-3">
                      <div className="space-y-1.5">
                        ...
                        <Input className="bg-[#161618] border border-[#2A2A2E] text-foreground placeholder:text-[#71717A] rounded-lg px-4 py-[14px] h-auto focus-visible:border-[#F5A524]/50 focus-visible:ring-0 focus-visible:ring-offset-0" id="signup-email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                      </div>
                      <div className="space-y-1.5">
                        <Label htmlFor="signup-password">{t("auth.password")}</Label>
                        <Input className="bg-[#161618] border border-[#2A2A2E] text-foreground placeholder:text-[#71717A] rounded-lg px-4 py-[14px] h-auto focus-visible:border-[#F5A524]/50 focus-visible:ring-0 focus-visible:ring-offset-0" id="signup-password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} />
                      </div>
