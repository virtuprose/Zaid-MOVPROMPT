import { ArrowRight, UserRound, Check, Pencil, Plus, Trash2 } from "lucide-react";
  ...
  if (kits.length === 0) {
    return (
      <section className="mb-6">
        ...
        >
          <div>
            <p className="text-sm font-medium text-foreground">Add your first character</p>
            <p className="text-xs text-muted-foreground mt-1">
              Save a person once — reuse them on every ad.
            </p>
          </div>
  ...
  return (
    <section className="mb-6">
      ...
      <div className="relative">
        <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 snap-x snap-mandatory scroll-smooth [scrollbar-width:thin]">
          {kits.map((k) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="w-12 h-12 rounded-full border border-border/40 bg-white/5 overflow-hidden flex items-center justify-center shrink-0">
                    {k.reference_url ? (
                      <img
                        src={k.reference_url}
                        alt=""
